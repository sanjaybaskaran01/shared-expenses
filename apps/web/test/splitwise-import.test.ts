...
describe("Splitwise CSV import", () => {
  ...
  test("keeps valid rows and reports actionable malformed-row warnings", () => {
    const csv = [
      "Date,Description,Category,Cost,Currency,Ananya,Dev",
...
describe("Splitwise JSON backup import", () => {
  ...
  test("preserves explicit payers, allocations, payments, recurrence, deletion, and group-less history", () => {
    const backup = {
      user: { id: 1, first_name: "Sanjay", email: "sanjay@example.com" },
      groups: [{
        id: 10,
        name: "Goa",
        members: [
          { id: 1, first_name: "Sanjay", balance: [{ currency_code: "USD", amount: "0.00" }] },
      ...
      expenses: [
        {
          ...
          payment: false,
          users: [
            { user: { id: 1, first_name: "Sanjay" }, paid_share: "60.00", owed_share: "30.00" },
        ...
        },
        {
          ...
          payment: true,
          users: [
            { user: { id: 1, first_name: "Sanjay" }, paid_share: "15.00", owed_share: "0.00" },
