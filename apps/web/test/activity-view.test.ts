...
describe("activity payment details", () => {
  test("exposes the people, amount, currency, date, and note for an auditable payment", () => {
    expect(paymentActivityDetails({
      ...
      payload: { payerId: "alex", recipientId: "maya", amountMinor: 3050, currency: "USD", paymentDate: "2026-07-30", note: "Paid by bank" },
    })).toEqual({ payerId: "alex", recipientId: "maya", amountMinor: 3050, currency: "USD", paymentDate: "2026-07-30", note: "Paid by bank" });
  });
