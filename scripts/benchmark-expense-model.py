...
CASES = [
    ...
    Case("multi-payer", "payers", "Groceries were $35 yesterday. I paid $20 and Maya paid $15. Just us.", {
        "kind": "expense", "description": "groceries", "amount": 35, "currency": "USD", "date": "yesterday", "payers": ["me", "maya"],
        "payerAllocations": {"me": 20, "maya": 15}, "participants": ["me", "maya"], "participantMode": "explicit-only", "reviews": [],
    }),
